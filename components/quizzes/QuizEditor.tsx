...
export function QuizEditor({ writableTags }: QuizEditorProps) {
  ...
  function newQuestion(): QuestionDraft {
    return newQuestionDraft(`${questionIdPrefix}-q${questionCounter.current++}`);
  }
    ...
    <div className="min-h-screen bg-[#f7f8fa]">
      ...
      <main className="mx-auto max-w-[760px] px-8 pb-32 pt-9">
        ...
        <button
          ...
          className="mt-4 flex h-10 items-center gap-2 rounded-lg border border-dashed border-slate-300 px-4 text-[12.5px] font-semibold text-slate-500 hover:border-brand-400 hover:text-brand-700"
        >
