    ...
    <div className="flex items-start justify-between gap-3 rounded-2xl border border-slate-200 bg-white p-[18px] shadow-sm">
      <div>
        <div className="flex items-center gap-2">
          <span className="rounded-md bg-slate-100 px-2 py-0.5 text-[10.5px] font-bold uppercase tracking-wide text-slate-500">
        ...
        <p className="mt-1.5 text-[12px] text-slate-500" suppressHydrationWarning>
...
export function CalendarView({ items, writableTags, currentUserId, isAdmin }: CalendarViewProps) {
