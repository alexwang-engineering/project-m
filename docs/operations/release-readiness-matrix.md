...
| Authorization | RLS-backed anonymous/student/teacher/admin/guardian isolation, all-tags-required teacher writes, disabled-user handling; 337 total pgTAP assertions |
...
- `npx supabase test db`: 25 files, 337 assertions passed.
