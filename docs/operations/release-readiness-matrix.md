...
| Authorization | RLS-backed anonymous/student/teacher/admin/guardian isolation, all-tags-required teacher writes, disabled-user handling; 319 total pgTAP assertions |
...
- `npx supabase test db`: 25 files, 319 assertions passed.
