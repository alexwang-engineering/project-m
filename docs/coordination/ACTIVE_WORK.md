...
|---|---|---|---|---|---|---|---|---|---|
| Package 0 | Product boundary and irreversible decisions (PM-01..PM-05) | Codex integration; human product owner approves | `integration/package-0` | `../project-m-package-0` | `main`@`bd8cab6` | `docs/coordination/**`, `docs/product/**`, `docs/adr/**` | REVIEW | School factual inputs remain pending; review required before merge | `35d143e` |
